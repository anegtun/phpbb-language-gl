...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Estes permisos empréganse para controlar o acceso a nivel global e aplícanse a todo o sistema. Divídense máis en detalle en Permisos de Usuarios, Permisos de Grupos, Administradores e Moderadores Globáis.</p>

		<h2>Permisos Dependentes do Foro</h2>
		<p>Empréganse para controlar o acceso básico foro por foro. Divídense en Permisos de Foro, Moderadores de Foro, Permisos de Usuarios no Foro e Permisos de Grupos no Foro.</p>

		<h2>Roles de Permisos</h2>
		<p>Os roles empréganse para crear diferentes xogos de permisos para os diferentes tipos deles dispoñíbeis, que máis tarde poden ser asignados a unha definición baseada en roles. Os roles predeterminados poden cubrir a administración de sistemas pequenos e grandes, mesmo dentro de cada unha das catro divisións, podes engadir/editar/eliminar roles de xeito que resposten ás túas necesidades.</p>
	...
	'ACL_TYPE_LOCAL_F_'		=> 'Permisos nos foros',

	'ACL_NO'				=> 'Non',
	'ACL_VIEW'				=> 'Visualizando os permisos',
	'ACL_VIEW_EXPLAIN'		=> 'Aquí podes ver os permisos efectivos que ten o usuario/grupo. Un cadrado vermello indica que o usuario/grupo non ten autorización, un cadrado verde indica que o usuario/grupo ten autorización.',
	'ACL_YES'				=> 'Si',
