...
$lang = array_merge($lang, array(
	'ADDED_PROFILE_FIELD'	=> 'Campo de perfil personalizado engadido correctamente.',
	...
	'CREATE_NEW_FIELD'			=> 'Crear un campo novo',
	'CUSTOM_FIELDS_NOT_TRANSLATED'	=> 'Cando menos un campo de perfil personalizado non foi traducido aínda. Introduce a información requirida premendo na ligazón &quot;Traducir&quot; ',
	...
	'DISPLAY_AT_PROFILE_EXPLAIN'	=> 'O usuario pode cambiar este campo de perfil dentro do seu panel de control de usuario.',
	...
	'EDIT_DROPDOWN_LANG_EXPLAIN'	=> 'Ten en conta que podes cambiar as túas opcións de texto e tamén engadir novas opcións ao final. Non é aconsellable engadir novas opcións no medio das existentes, porque podería ter como resultado asignar opcións erróneas aos teus usuarios. Isto tamén pode suceder se eliminas opcións que están no medio. Eliminando opcións dende o final resultará en que os usuarios que teñan este elemento asignado agora volverán ao estado predeterminado.',
	...
	'FIELD_IDENT_ALREADY_EXIST'	=> 'O nome de campo escollido xa existe. Escolle outro nome.',
	'FIELD_IDENT_EXPLAIN'		=> 'O nome de campo é un nome para identificar o campo de perfil dentro da base de datos e nos modelos.',
	'FIELD_INT'					=> 'Números',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Agocha o campo do perfil a todos os outros usuarios agás o propio, administradores e moderadores. Se a opción Amosar no panel de control do usuario está desactivada, o usuario non poderá ver ou mudar este campo, e poderá ser mudado só polos administradores.',

	'INVALID_CHARS_FIELD_IDENT'	=> 'O nome do campo só pode conter minúsculas da a-z e_',
	'INVALID_FIELD_IDENT_LEN'	=> 'O nome do campo só pode conter ata 17 caracteres',
	...
	'SHOW_NOVALUE_FIELD'			=> 'Amosar o campo se non se escolleu ningún valor',
	...
	'STEP_1_EXPLAIN_EDIT'			=> 'Aquí podes cambiar os parámetros básicos do teu campo de perfil. As opcións relevantes re-calcularanse no segundo paso onde podes previsualizar e comprobar os axustes feitos.',
	...
	'STEP_3_EXPLAIN_CREATE'			=> 'Ao ter máis dun idioma instalado tes que encher tamén os restantes elementos de idioma. O campo de perfil traballará co idioma predeterminado activado, podes cubrir os elementos restantes de idioma máis tarde.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Ao ter máis dun idioma instalado podes cambiar ou engadir tamén os restantes elementos de idioma. O campo de perfil traballará co idioma predeterminado activado.',
